...
const features = [
  ...
  {
    icon: <FaPlug className="text-pink-600  text-3xl" />,
    title: "My Projects",
    description:
      "A collection of all projects I have worked on have worked on. List is growing by day.",
  },
  {
    icon: <FaChartBar className="text-teal-600  text-3xl" />,
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-1">
          {features.map((feature, index) => (
            <div key={index} className="w-full text-center group">
              <div className="bg-gray-100 rounded-lg flex justify-center items-center mb-5 w-20 h-20 mx-auto transition-all duration-500 ">
                {feature.icon}
              </div>
